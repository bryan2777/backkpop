      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-white p-8 rounded-2xl border-2 border-red-200 max-w-3xl mx-auto shadow-lg">
          ...
          <p className="text-base md:text-lg text-gray-700 leading-relaxed text-center">
            Percebemos que você mostrou <strong>interesse nos K-pop Amigurumis</strong> e preparamos um <strong>desconto final de 50%</strong> para garantir que você não perca essa oportunidade de criar bonecos adoráveis de K-pop em crochê!
          </p>
        </div>
      </div>
    </section>
